					...
					<div>
								...
								<strong>
									<span>
										<span data-custom-class="subtitle">
											Last updated <bdt className="question">December 30, 2020</bdt>
										</span>
									</span>
								</strong>
							</span>
						...
						<div>
							<span>
								<span>
									...
									<span data-custom-class="body_text">
										", "<strong>we</strong>", "<strong>us</strong>", "<strong>our</strong>"). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us at <bdt className="question">hello@elenacalvillo.com</bdt>.
									</span>
								</span>
							</span>
						</div>
								...
								<span>
									<span data-custom-class="body_text">
										...
										<bdt className="question">
											<a href="https://www.elenacalvillo.com" target="_blank" data-custom-class="link">
												https://www.elenacalvillo.com
											</a>
										</bdt>{' '}
						...
						<div>
							<span>
								<a data-custom-class="link" href="#caresidents">
									<span>11. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</span>
								</a>
							</span>
						</div>
						<div>
								...
								<span>
									<span data-custom-class="body_text">
										...
										<span>
											...
											<span data-custom-class="body_text">
												<bdt className="forloop-component" />
												<bdt className="question">feedback</bdt>;&nbsp;
											</span>
											<span data-custom-class="body_text">
												<bdt className="forloop-component" />
						...
						<div>
							<span>
								<span>
									<span data-custom-class="body_text">
										Like many businesses, we also collect information through cookies and similar technologies. <bdt className="block-component" />
										<bdt className="block-component" />
										<bdt className="statement-end-if-in-editor">
											<span data-custom-class="body_text" />
										</bdt>
										...
										<span data-custom-class="body_text">
											...
											<span>
												<span>
													<span data-custom-class="body_text">
														<bdt className="block-component" />
														<bdt className="question">hello@elenacalvillo.com</bdt>
								...
								<span>
									<span>
										...
										<span data-custom-class="body_text">
											...
											, products, marketing and your experience. We may use and store this information in aggregated and anonymized form so that it is not associated with individual end users and does not include personal information. We will not use identifiable personal information without your consent.
											<bdt className="statement-end-if-in-editor" />
										</span>
									</span>
								</span>
								...
								<span>
									<span>
										<span>
											<span id="control">
												<strong>
													<span data-custom-class="heading_1">3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</span>
												</strong>
											</span>
										</span>
									</span>
							...
							<span>
								<span>
									<span data-custom-class="body_text">
										...
										<em>&nbsp; We only share information with your consent, to comply with laws, to provide you with services, to protect your rights, or to fulfill business obligations.</em>
									</span>
								</span>
							</span>
						</div>
								...
								<div>
									...
									<div>
													...
													<span>
														<span>
															<span>
																<span id="control">
																	<strong>
																		<span data-custom-class="heading_1">4. WHO WILL YOUR INFORMATION BE SHARED WITH?</span>
																	</strong>
																	&nbsp;
																</span>
																&nbsp;
													...
													<span>
														...
														<span data-custom-class="body_text">
															<span>
																<span>
																	<bdt className="block-component" />
																	<bdt className="question">Hotjar</bdt>
																	<bdt className="block-component" />
																</span>
															</span>
														</span>
													...
													<span>
														...
														<span data-custom-class="body_text">
															<span>
																<span>
																	<bdt className="block-component" />
																	<bdt className="question">Google Fonts</bdt>
																	<bdt className="block-component" />
																</span>
															</span>
														</span>
												...
												<span data-custom-class="body_text">
													<span>
														<span>
															...
															<span>
																<span>
																	&nbsp;<bdt className="question">Instagram embed</bdt>
																	<bdt className="else-block" />
																</span>
															</span>
														</span>
												...
												<span data-custom-class="body_text">
													<span>
														<span>
															...
															<span>
																<span>
																	&nbsp;<bdt className="question">Hotjar Recruiter widget</bdt>
																	<bdt className="else-block" />
																</span>
															</span>
														</span>
													...
													<span>
														...
														<span data-custom-class="body_text">
															<span>
																<span>
																	<bdt className="block-component" />
																	<bdt className="question">GitHub Pages</bdt>
																	<bdt className="block-component" />
																</span>
															</span>
														</span>
												...
												<span data-custom-class="body_text">
													<span>
														<span>
															...
															<span>
																<span>
																	&nbsp;<bdt className="question">Netlify </bdt>
																	<bdt className="else-block" />
																</span>
															</span>
														</span>
													...
													<span>
														...
														<span data-custom-class="body_text">
															<span>
																<span>
																	<bdt className="block-component" />
																	<bdt className="question">Instagram advertising</bdt>
																	<bdt className="block-component" />
																</span>
															</span>
														</span>
													...
													<span>
														...
														<span data-custom-class="body_text">
															<span>
																<span>
																	<bdt className="block-component" />
																	<bdt className="question">Google Analytics</bdt>
																	<bdt className="block-component" />
																</span>
															</span>
														</span>
												...
												<span data-custom-class="body_text">
													<span>
														<span>
															...
															<span>
																<span>
																	&nbsp;<bdt className="question">MixPanel </bdt>
																	<bdt className="else-block" />
																</span>
															</span>
														</span>
													...
													<span>
														...
														<span data-custom-class="body_text">
															<span>
																<span>
																	<bdt className="block-component" />
																	<bdt className="question">HappyApps</bdt>
																	<bdt className="block-component" />
																</span>
															</span>
														</span>
													...
													<span>
														<span>
															<span>
																<span id="control">
																	<strong>
																		<span data-custom-class="heading_1">8. DO WE COLLECT INFORMATION FROM MINORS?</span>
																	</strong>
																</span>
															</span>
														</span>
													...
													<span>
														<span>
															<span>
																<span id="control">
																	<strong>
																		<span data-custom-class="heading_1">9. WHAT ARE YOUR PRIVACY RIGHTS?</span>
																	</strong>
																</span>
															</span>
														</span>
												...
												<span>
													<span>
														<span>
															<span id="control">
																<strong>
																	<span data-custom-class="heading_1">10. CONTROLS FOR DO-NOT-TRACK FEATURES</span>
																</strong>
															</span>
														</span>
													</span>
												...
												<span>
													<span>
														<span>
															<span id="control">
																<strong>
																	<span data-custom-class="heading_1">11. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</span>
																</strong>
															</span>
														</span>
													</span>
												...
												<span>
													<span>
														<span data-custom-class="body_text">
															<span>
																<span>
																	<span data-custom-class="body_text">The California Code of Regulations defines a "resident" as:</span>
																</span>
															</span>
														</span>
													</span>
										...
										<div>
											<span>
												<span>
													<span data-custom-class="body_text">All other individuals are defined as "non-residents."</span>
												</span>
											</span>
										</div>
										<div>
										...
										<div>
											<span>
												<span>
													<span data-custom-class="body_text">If this definition of "resident" applies to you, we must adhere to certain rights and obligations regarding your personal information.</span>
												</span>
											</span>
										</div>
										<div>
												...
												<tr>
													...
													<td>
														<div>
															<span>
																<span>
																	<span data-custom-class="body_text">Browsing history, search history, online behavior, interest data, and interactions with our and other websites, applications, systems and advertisements</span>
																</span>
															</span>
														</div>
													</td>
												...
												<tr>
													...
													<td>
														<div>
															<span>
																<span>
																	<span data-custom-class="body_text">Business contact details in order to provide you our services at a business level, job title as well as work history and professional qualifications if you apply for a job with us</span>
																</span>
															</span>
														</div>
													</td>
													...
													<div>
														...
														<div>
															...
															<div>
																<span>
																	<span>
																		...
																		<span>
																			<span data-custom-class="body_text">
																				<bdt className="question">hello@elenacalvillo.com</bdt>, <bdt className="block-component" />
																				<bdt className="block-component" />
																			</span>
																			<span data-custom-class="body_text">
																				<bdt className="block-component" />
															...
															<div>
																<span>
																	<span>
																		<span data-custom-class="body_text">If you are using an authorized agent to exercise your right to opt-out we may deny a request if the authorized agent does not submit proof that they have been validly authorized to act on your behalf.</span>
																	</span>
																</span>
															</div>
															<div>
															...
															<div>
																<span>
																	<span>
																		<span>
																			<span data-custom-class="body_text">
																				<bdt className="question">Elena Calvillo</bdt>
																			</span>
																			<span data-custom-class="body_text">
																			...
																			<div>
																							...
																							<span>
																								<span data-custom-class="body_text">
																									<span>
																										<span data-custom-class="body_text">
																											<bdt className="block-component" />
																											by email at <bdt className="question">hello@elenacalvillo.com</bdt>, <bdt className="block-component" />
																											<bdt className="block-component" />
																										</span>
																										<span data-custom-class="body_text">
																											<bdt className="block-component" />
																						...
																						<span>
																							<span>
																								<span>
																									<span id="control">
																										<strong>
																											<span data-custom-class="heading_1">12. DO WE MAKE UPDATES TO THIS NOTICE?</span>
																										</strong>
																										&nbsp;
																									</span>
																									&nbsp;
																						...
																						<span>
																							<span>
																								<span>
																									<span id="control">
																										<strong>
																											<span data-custom-class="heading_1">13. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</span>
																										</strong>
																										&nbsp;
																									</span>
																									&nbsp;
																						...
																						<span>
																							<span data-custom-class="body_text">
																								...
																								<span>
																									<span data-custom-class="body_text">
																										<bdt className="block-component" />
																										email us at <bdt className="question">hello@elenacalvillo.com</bdt>
																										<bdt className="statement-end-if-in-editor" />
																									</span>
																								</span>
																								or by post to:
																				...
																				<div>
																					<span>
																						<span data-custom-class="body_text">
																							...
																							<span>
																								<span>
																									<bdt className="block-component" />, <bdt className="question">Jalisco</bdt>
																									<bdt className="statement-end-if-in-editor" />
																									<bdt className="block-component" /> <bdt className="question">45080</bdt>
																									<bdt className="statement-end-if-in-editor" />
																								</span>
																								<span>
																									<bdt className="block-component" />
																						...
																						<span>
																							<span>
																								<span>
																									<span id="control">
																										<strong>
																											<span data-custom-class="heading_1">14. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</span>
																										</strong>
																										&nbsp;
																									</span>
																									&nbsp;
																				...
																				<div>
																					<span>
																						<span>
																							<span data-custom-class="body_text">
																								Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it in some circumstances. To request to review, update, or delete your personal information, please <bdt className="block-component" />
																								submit a request form by clicking&nbsp;
																							</span>
																							<span>
																								<span data-custom-class="body_text">
																									<span>
																										<a data-custom-class="link" href="https://app.termly.io/notify/f2aeca7d-0172-458b-af70-33a5777b9fdd" rel="noopener noreferrer" target="_blank">
																											here
																										</a>
																									</span>
																								</span>
